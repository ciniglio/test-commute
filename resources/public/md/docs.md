...
Two middleware functions are provided by default in the `test-commute.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `test-commute.handler` namespace to manage the enabled middleware.
